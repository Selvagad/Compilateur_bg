...
// Remarque : la classe ne contient aucun constructeur
  public:
    ...
    virtual void traduitEnCPP(ostream & cout, unsigned int indentation) const=0;    //methode qui va permettre de traduire en C++ les fonctions
...
public:
    NoeudInstEcrire(std::vector<Noeud*> parametres);
    ~NoeudInstEcrire(){}
    int executer();
